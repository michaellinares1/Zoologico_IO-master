<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="Provedor_Alimento.aspx.cs" Inherits="Granja_Proyecto_IO.Pages.Provedor_Alimento" %>
        ...
        <table class="table table-striped table-dark t-dark mt-4" id="table-items">
            <thead class="text-center">
                <tr>
                    ...
                    <th scope="col">CapacidadMin</th>
                    <th scope="col">CapacidadMax</th>
                    <th scope="col">Precio Kg</th>
                </tr>
            </thead>
            <tbody class="text-center">
                <asp:Literal runat="server" ID="ltlProvedorAlimentos"></asp:Literal>
            </tbody>
        </table>
