<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="Proveedor.aspx.cs" Inherits="Granja_Proyecto_IO.Pages.Proveedor.Proveedor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <tbody class="text-center">
            <asp:Literal runat="server" ID="ltlProveedores"></asp:Literal>
        </tbody>
    </table>
