<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="ReporteAli.aspx.cs" Inherits="Granja_Proyecto_IO.Pages.DetalleReporte.Abastecimient" %>
      ...
      <div class="container">
        ...
        <thead class="text-center">
            <tr>
                ...
                <th scope="col">KG Abastecidos</th>
                <th scope="col">Costo</th>
            </tr>
        </thead>
        <tbody class="text-center">
            <asp:Literal runat="server" ID="ltlAbastecimiento"></asp:Literal>
        </tbody>
    </table>
