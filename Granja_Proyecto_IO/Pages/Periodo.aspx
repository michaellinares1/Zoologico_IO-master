<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="Periodo.aspx.cs" Inherits="Granja_Proyecto_IO.Pages.Periodo.Periodo" %>
    ...
    <div class="container">
        ...
        <table class="table table-striped table-dark t-dark mt-5" id="table-items">
            ...
            <tbody class="text-center">
                <asp:Literal runat="server" ID="ltlPeriodos"></asp:Literal>
            </tbody>
        </table>
