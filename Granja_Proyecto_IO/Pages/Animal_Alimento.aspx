<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="Animal_Alimento.aspx.cs" Inherits="Granja_Proyecto_IO.Pages.Animal_Alimento" %>
    ...
    <div class="container">
        ...
        <table class="table table-striped table-dark t-dark mt-4" id="table-items">
            ...
            <tbody class="text-center">
                <asp:Literal runat="server" ID="ltlAnimalAlimento"></asp:Literal>
            </tbody>
        </table>
