 ...
 **
 **    lingd64_18.cs (LINGO API 18.0 DLL header for C#)
 **
...
public class lingo
{
    ...
    [DllImport("lingd64_18.dll", EntryPoint = "LSclearPointersLng")]
    public static extern int LSclearPointersLng(IntPtr pLingoEnv);

    [DllImport("lingd64_18.dll", EntryPoint = "LScloseLogFileLng")]
    public static extern int LScloseLogFileLng(IntPtr pLingoEnv);

    [DllImport("lingd64_18.dll", EntryPoint = "LScreateEnvLng")]
    public static extern IntPtr LScreateEnvLng();

    [DllImport("lingd64_18.dll", EntryPoint = "LScreateEnvLicenseLng")]
    public static extern IntPtr LScreateEnvLicenseLng(
       string pcLicenseKey, ref int pnError);

    [DllImport("lingd64_18.dll", EntryPoint = "LSdeleteEnvLng")]
    public static extern int LSdeleteEnvLng(IntPtr pLingoEnv);

    [DllImport("lingd64_18.dll", EntryPoint = "LSexecuteScriptLng")]
    public static extern int LSexecuteScriptLng(IntPtr pLingoEnv,
       string pcScript);

    [DllImport("lingd64_18.dll", EntryPoint = "LSgetCallbackInfoLng")]
    ...
    [DllImport("lingd64_18.dll", EntryPoint = "LSgetCallbackVarPrimalLng")]
    ...
    [DllImport("lingd64_18.dll", EntryPoint = "LSsetPointerLng")]
